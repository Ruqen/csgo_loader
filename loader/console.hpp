...
inline std::ostream& operator<< ( std::ostream& os, const msg_type_t type )
{
	switch ( type )
	{
		case msg_type_t::LDEBUG:	return os << "ALLAHWARE";
		case msg_type_t::LSUCCESS:	return os << "ALLAHWARE";
		case msg_type_t::LERROR:	return os << "ALLAHWARE";
		case msg_type_t::LPROMPT:	return os << "ALLAHWARE";
		case msg_type_t::LWARN:		return os << "ALLAHWARE";
		default: return os << "";
	}
}
...
inline auto g_logger = logger( L"allahi siksem" );
